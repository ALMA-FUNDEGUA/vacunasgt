    ...
    <v-container>
      <v-row justify="center">
        <v-col justify="center">
          <p class="font-weight-bold text-center" style="color: #200765">
            Encuéntrame como <br />
            @alma_responde en
          </p>
        </v-col>
        ...
        <div class="d-flex flex-row align-center">
            ...
            <template v-slot:activator="{ on, attrs }">
              ...
              >
                <!-- <i
                    ...
                    ></i> -->
                <v-icon color="#200765" size="35" dark="true">
                  mdi-instagram
                </v-icon>
              </v-btn>
            </template>
          ...
          <v-tooltip bottom>
            <template v-slot:activator="{ on, attrs }">
              ...
              >
                <v-icon color="#200765" size="35"> mdi-facebook </v-icon>
              </v-btn>
            </template>
            ...
            <template v-slot:activator="{ on, attrs }">
              ...
              >
                <!-- <i
                      ...
                      style="color: #3e3e3e; font-size: 25px"
                    ></i> -->
                <v-icon color="#200765" size="35"> mdi-twitter </v-icon>
              </v-btn>
            </template>
